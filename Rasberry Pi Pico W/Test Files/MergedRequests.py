...
def sub_cb(topic, msg):
    global master_control, pairing, pairing_details
    ...
    if msg == "Turn Off":
        ...
        print(f"LockID Server: {pairing_details[2]}, LockID Client: {lock_id}, True?: {pairing_details[2] == str(lock_id)}")
...
try:
    ...
    while True:
        ...
        if not wlan.isconnected() and not lan_connect:
            ...
            lan_timer.init(period=6000, mode=Timer.PERIODIC, callback=attempt_connection)
